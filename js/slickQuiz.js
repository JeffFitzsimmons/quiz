...
(function($){
    $.slickQuiz = function(element, options) {
        ...
        // Set via json option or quizJSON variable (see config.js)
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="btn btn-sm btn-primary ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a></p>');
                }
                    ...
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var startDiv = '<div class="' + inputType + '">';
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<div class="col-sm-offset-3 col-sm-7"><a href="#" class="btn btn-lg btn-primary ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a></div>');
                        }
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<div class="col-sm-offset-3 col-sm-7"><a href="#" class="btn btn-lg btn-primary ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a></div>');
                        } else {
                            questionHTML.append('<div class="col-sm-offset-3 col-sm-7"><a href="#" class="btn btn-lg btn-primary ' + nextQuestionClass + '">' + nextText + '</a></div>');
                            questionHTML.append('<div class="col-sm-offset-3 col-sm-7"><a href="#" class="btn btn-lg btn-primary ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a></div>');
                        }
